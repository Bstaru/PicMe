...
public class RegistrarUsuarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Boolean b = Boolean.parseBoolean(tipoid.trim());
        
        String privado = request.getParameter("privado");        
        Boolean b2 = Boolean.parseBoolean(privado.trim());
      ...
      if(co.registrar(usuario,contra,correo,gender,imgPer,imgCov,nombre,acerca,b,b2,FeNac,resp,ciudad,preg)){
